...
export default function SearchClient() {
  ...
  const activeFilterCount = Object.entries(filters).filter(
    ([k, v]) => v && v !== initialFilters[k as keyof typeof initialFilters],
  ).length;
          ...
          <>
            <FilterGroup title="Basic Details">
              ...
              <RangeRow
                ...
                onMin={(v) => update("heightMin", v)}
                onMax={(v) => update("heightMax", v)}
              />
              <SelectField
              ...
              <SelectField
                ...
                options={PHYSICAL_STATUS_LABELS}
              />
            </FilterGroup>
            ...
            <FilterGroup title="Religious & Astro Details">
              ...
              <SelectField
                ...
                options={NAKSHATRA_LABELS}
              />
              <SelectField
                label="Dosham"
                value={filters.dosham}
                onChange={(v) => update("dosham", v)}
                options={DOSHAM_LABELS}
              />
              <CheckboxField
                label="Only profiles with horoscope"
                checked={filters.hasHoroscope === "true"}
                onChange={(c) => update("hasHoroscope", c ? "true" : "")}
              />
            </FilterGroup>
            ...
            <FilterGroup title="Professional Details">
              ...
              <SelectField
                ...
                onChange={(v) => update("occupationCategory", v)}
                options={OCCUPATION_CATEGORY_LABELS}
              />
            </FilterGroup>
            ...
            <FilterGroup title="Lifestyle">
              <SelectField
                label="Eating Habits"
                value={filters.eatingHabit}
                onChange={(v) => update("eatingHabit", v)}
                options={EATING_HABIT_LABELS}
              />
              <SelectField
                label="Smoking Habits"
                value={filters.smokingHabit}
                onChange={(v) => update("smokingHabit", v)}
                options={SMOKING_HABIT_LABELS}
              />
              <SelectField
                label="Drinking Habits"
                value={filters.drinkingHabit}
                onChange={(v) => update("drinkingHabit", v)}
                options={DRINKING_HABIT_LABELS}
              />
            </FilterGroup>
            ...
            <FilterGroup title="Family Details">
              <SelectField
                ...
                options={FAMILY_STATUS_LABELS}
              />
              <SelectField
                label="Family Value"
                value={filters.familyValue}
                onChange={(v) => update("familyValue", v)}
                options={FAMILY_VALUE_LABELS}
              />
              <SelectField
                label="Family Type"
                value={filters.familyType}
                onChange={(v) => update("familyType", v)}
                options={FAMILY_TYPE_LABELS}
              />
            </FilterGroup>
            ...
            <FilterGroup title="Profile Type">
              <CheckboxField
                ...
                onChange={(c) => update("hasPhoto", c ? "true" : "")}
              />
            </FilterGroup>
                  ...
                  return (
                    <div key={p.id} style={styles.card}>
                      ...
                      <div style={styles.cardBody}>
                        ...
                        {p.profession && (
                          <p style={styles.cardDetail}>💼 {p.profession}</p>
                        )}
                        {p.location && (
                          <p style={styles.cardDetail}>📍 {p.location}</p>
                        )}
                      </div>
