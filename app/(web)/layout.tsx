...
export default async function WebLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#fff0f3', fontFamily: 'system-ui, sans-serif' }}>
      {user && (
        <nav style={styles.nav}>
          ...
          <div style={styles.linksGroup}>
            <Link href="/matches" style={styles.link}>Matches</Link>
            <Link href="/interests" style={styles.link}>Interests</Link>
          ...
          <div style={styles.rightGroup}>
            ...
            <form action={logoutAction}>
              <button type="submit" style={styles.logoutButton}>Log Out</button>
            </form>
          </div>
        </nav>
      )}
